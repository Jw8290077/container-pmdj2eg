...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-pmdj2eg.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-pmdj2eg.containers.anotherwebservice.com/
...
```
git clone git@github.com:Jw8290077/container-pmdj2eg.git
cd container-pmdj2eg
```
...
```
docker attach container-pmdj2eg
```
